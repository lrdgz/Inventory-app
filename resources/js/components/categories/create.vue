                                        ...
                                        <div class="form-group">
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" v-model="form.category_name" placeholder="Enter Name">
                                                    <small class="text-danger" v-if="errors.category_name">{{ errors.category_name[0] }}</small>
                                                </div>
                                                <div class="col-md-6">
                                                    <label>Category Code</label>
                                                    <input type="text" class="form-control" v-model="form.category_code" placeholder="Enter Code">
